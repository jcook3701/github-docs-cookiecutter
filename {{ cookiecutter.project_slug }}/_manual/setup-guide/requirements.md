...
## {{ cookiecutter.project_name }} Requirements
...
2. [Nutri-Matic](https://github.com/jcook3701/nutri-matic)
    __Note:__
    __Example:__ Install with the following command (Recommended that this is installed in a python [virtual environment]({% raw %}{% link _manual/tutorials/create-virtual-env.md %}{% endraw %})):
    ```shell
